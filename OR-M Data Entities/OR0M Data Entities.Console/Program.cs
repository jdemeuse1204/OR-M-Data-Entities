...
namespace OR0M_Data_Entities.Console
{
    internal class Program
    {
        private static void Main(string[] args)
        {
            ...
            var duration = Profiler.OnlyProfile("", 10, () =>
            {
                ...
                //var result = context.From<NickOfTime.ServiceModels.DataTransferObjects.ORM.Lite.ReadOnlyJob>().FirstOrDefault(w => w.JobId == 101);
                var result = context.From<NickOfTime.ServiceModels.DataTransferObjects.ORM.Main.ReadOnlyJob>().FirstOrDefault(w => w.JobId == 101);
