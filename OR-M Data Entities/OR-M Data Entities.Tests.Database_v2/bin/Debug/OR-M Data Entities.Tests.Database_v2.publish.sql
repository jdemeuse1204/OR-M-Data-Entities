...
GO
PRINT N'Creating [ts].[TestUpdateNewSchema]...';


GO
CREATE TABLE [ts].[TestUpdateNewSchema] (
...
GO
PRINT N'Creating [ts].[TestUpdateWithKeyDbGenerationOptionNone]...';


GO
CREATE TABLE [ts].[TestUpdateWithKeyDbGenerationOptionNone] (
    [Id]   INT          NOT NULL,
    [Name] VARCHAR (50) NULL,
    PRIMARY KEY CLUSTERED ([Id] ASC)
);
...
GO
PRINT N'Creating [ts].[SchemaChangeOne]...';
...
GO
PRINT N'Creating [dbo].[StringKeyTest]...';


GO
CREATE TABLE [dbo].[StringKeyTest] (
    [Id]    VARCHAR (50)  NOT NULL,
    [Value] VARCHAR (MAX) NULL,
    CONSTRAINT [PK_StringKeyTest] PRIMARY KEY CLUSTERED ([Id] ASC)
);
