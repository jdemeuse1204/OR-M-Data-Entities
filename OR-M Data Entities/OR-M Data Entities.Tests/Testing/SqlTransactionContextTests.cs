...
namespace OR_M_Data_Entities.Tests.Testing
{
    ...
    public class SqlTransactionContextTests
    {
        ...
        {
            Assert.IsTrue(OtherTests.Test_4(_ctx));
        }
        #endregion
    }
}
