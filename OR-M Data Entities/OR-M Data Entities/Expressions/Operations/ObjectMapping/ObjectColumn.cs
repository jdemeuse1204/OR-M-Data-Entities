...
namespace OR_M_Data_Entities.Expressions.Operations.ObjectMapping
{
	public class ObjectColumn : ObjectFunctionTextBuilder
	{
		...
		{
			return parentTableHasForeignKey ? string.Format("{0}{1}", HasAlias ? TableAlias : TableName, Name) : Name;
		}
		...
		public ObjectColumn(PropertyInfo memberInfo, int order, string tableName = "", string alias = "", bool isSelected = true)
		{
